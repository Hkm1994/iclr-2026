...
| **`scripts/streamlit_inspect_predictions.py`** | Interactive **pred vs actual** inspection (train/val/test buffer, slices, 3D error, GIF). See **`docs/INSPECT_PREDICTIONS.md`**. |
...
| Prediction diagnostics | `training/diagnostics_velocity.py`, `training/inspect_predictions_common.py`, `training/inspect_viz.py` |
